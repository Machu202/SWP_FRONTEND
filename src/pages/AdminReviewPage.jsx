...
function AdminDecisionRow({ item, summary, tantous, selectedTantou, onTantouChange, onApprove, onReject }) {
  return (
    <div className="review-row admin-review-row">
      ...
      <div className="vote-panel">
        ...
        <select value={selectedTantou} onChange={(event) => onTantouChange(event.target.value)}>
        ...
        <div className="button-row vertical-buttons">
          <button className="btn btn-primary" onClick={onApprove}>Admin approve</button>
