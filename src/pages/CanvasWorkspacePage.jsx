            ...
            {versions.length ? (
              <div className="page-version-list">
                {versions.map((version) => {
                  ...
                  const selectedVersion = String(viewedVersionId) === String(version.id);
                  return (
                    <div className="page-version-row" key={version.id}>
                      <button
                        type="button"
                        className={selectedVersion ? "active" : ""}
                        title={selectedVersion ? "Click again to return to the latest page image" : `View Version ${versionNumber}`}
                        onClick={() => {
                          ...
                          setViewedVersionId(String(version.id));
